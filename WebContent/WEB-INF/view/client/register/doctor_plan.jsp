...
.currentWeek, .lastWeek, .nextWeek, .afterFourWeek, #dateTime {
	position: absolute;
	cursor: pointer;
}
...
<body>
	<div class="panel-body" style="padding-bottom: 0px;">
		...
		<!-- 患者ID -->
		<input id="patId" value="${patId}" name="patId" type="hidden">
		<!-- 登录用户类型 -->
						...
						<div class="row">
							...
							<div class="col-sm-10">
								<div class="form-group">
									<span class="currentWeek">本周</span> <span class="lastWeek"> < 上周 </span>
									<div class="col-sm-2">
										<input type="text" class="form-control" id="dateTime" name="dateTime">
										<span class="date-icon" style="right: 16px; bottom: 7px; position: absolute;"></span>
									</div>
									<span class="nextWeek"> 下周 > </span> <span class="afterFourWeek"> 四周后 </span>
								</div>
								<div class="form-group">
									<ul class="item_list col-sm-8" style="width:500px;">
				...
				<div class="modal-body">
						...
						<div class="col-md-12">
							<form id="doctorInfo" class="form-horizontal">
								<div class="form-group">
									...
									<div class="col-sm-2">
										<select class="form-control" name="city" id="city" onchange="changeCate();" url="/enjoyhisfy/client/framework/FrameworkCommonAction/query4Info.json?table=his_organiz&&column1=id&&column2=city&&sqlstr={'where':'city IS NOT NULL GROUP BY city'}">
										</select>
									</div>
									...
									<div class="col-sm-2">
										<select class="form-control" id="dentistId" data-id="${register.dentistId}" url="/enjoyhisfy/client/framework/FrameworkCommonAction/query4DropDown.json?table=his_employee&&column1=id&&column2=employee_name&&sqlstr={'where':'user_type=1 and is_show=1'}"></select>
									</div>
								</div>
							</form>
							<hr />
							<form id="bookingForm" class="form-horizontal">
								...
								<div class="col-sm-12">
									...
									<div class="form-group">
										<input type="hidden" class="form-control" id="age" name="age" placeholder="请输入年龄" value="${register.patient.age }" onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength=3> <label class="control-label col-sm-1">生日</label>
										<div class="col-sm-2">
										...
										<div class="col-sm-2">
											<div id="source-div1" style="display: block">
												<input type="hidden" id="oldSource" value="${register.patient.source}"> <select class="form-control" id="source" name="source" required="required" data-id="${register.patient.source }" url="/enjoyhisfy/client/framework/FrameworkCommonAction/query4DropDown.json?table=his_dict&&column1=dict_name&&column2=dict_name&&sqlstr={'where':'dict_type=\'HZLY\''}">
												</select>
											</div>
							...
							<div class="form-group">
								<div class="col-sm-3">
									<label class="control-label">预约日期&nbsp;
										<input readonly="readonly" style="border: none; width: 80px; color: red;" id="appointmentDate" name="appointmentDate" required="required">
									</label>
									<br>
									<span class="lastWeek2"> < 上周 </span>&nbsp;<span class="currentWeek2">本周</span>&nbsp;
									<span class="nextWeek2"> 下周 > </span>&nbsp;<span class="afterFourWeek2"> 四周后 </span>
									<div id="appointmentDateDiv"></div>
								</div>
								<div class="col-sm-5">
									<label class="control-label">预约时间<span style="color: red;" id="bookingTime"></span>&nbsp;&nbsp;&nbsp;&nbsp; 时长(<span id="bookingLength" style="color: red;"></span>分钟)
									</label>
								...
								<div class="col-sm-4">
									<label class="control-label">预约目的：</label> <input type="text" id="serviceItems" readonly="readonly" style="text-align: center; width: 70px;" name="serviceItems" value="${register.serviceItems}"> <br> <br>
									...
									<div class="form-group">
										...
										<div>
											<textarea class="form-control" name="remark" id="remark" rows="" cols=""></textarea>
										</div>
										<div class="checkbox">
					...
					<div class="container-fluid">
						<div class="col-sm-12 text-right btngroup checkbox">
							...
							<input type="button" class="btn btn-primary newBtnsure" value="另存为新预约" /> <input type="button" class="btn btn-default cancelBooking" data-dismiss="modal" style="background: #ccc; border-color: #ccc;" value="取消预约" />
	...
	<!-- 省略号的弹出框 -->
	<div class="table-responsive" style="display: none" id="detail_table"></div>
</body>
</html>
...
<script src="${path}/js/client/date.format.js"></script>
<script src="${path}/js/client/util.js"></script>
<script src="${path}/js/client/select.js"></script>
<script src="${path}/js/client/doctor_plan.js"></script>
<script src="${path}/js/client/introducerSearch.js"></script>
