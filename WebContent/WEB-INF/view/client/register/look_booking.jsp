			...
			<form id="booking-form" class="form-horizontal" role="form" action="/enjoyhisfy/client/register/save_booking" method="post">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input  readonly="readonly" type="text" class="form-control" id="birthday" name="strBirthday" value="${register.patient.fmtBirthday }" required="required"  placeholder="请选择" readonly="readonly">
						</div>
					      <span class="date-icon" style="right: 127px;bottom: 22px;position: absolute;">
					      	<img class="img-responsive center-block"  readonly="readonly"/>
					      </span>
					</div>
				</div>
				<div class="col-sm-6">
						...
						<div class="col-sm-8">
							<c:choose>
								<c:when test="${userType==1}">
									<select  readonly="readonly" class="form-control" id="dentistId" name="dentistId" required="required" data-id="${uid}" url="/enjoyhisfy/client/framework/FrameworkCommonAction/query4DropDown.json?table=his_employee&&column1=id&&column2=employee_name&&sqlstr={'where':'id=${uid}'}">
									</select>
								</c:when>
								<c:otherwise>
									<select  readonly="readonly" class="form-control" id="dentistId" name="dentistId" required="required" data-id="${register.dentistId }" url="/enjoyhisfy/client/framework/FrameworkCommonAction/query4DropDown.json?table=his_employee&&column1=id&&column2=employee_name&&sqlstr={'where':'user_type=1 and is_show=1'}">
									</select>
								</c:otherwise>
							</c:choose>
						</div>
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="bookingDate" name="bookingDate" value="${register.bookingDate}" readonly="readonly">
						</div>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" id="begin" name="begin" value="${register.begin }" readonly="readonly">
						</div>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="hidden" id="appoLenId" value="${register.appoLen}"  readonly="readonly"/>
							<select class="form-control" id="appoLen"  readonly="readonly">
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<!-- 
							<select class="form-control" id="serviceItems" name="serviceItems" required="required" data-id="${register.serviceItems }"  readonly="readonly"
							 ...
							 -->
							<input type="type" class="form-control" id="serviceItems" name="serviceItems" value="${register.serviceItems }" readonly="readonly">
						</div>
					</div>
				</div>
				<div class="col-sm-6" style="display: none;">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="hidden" class="form-control" id="end" name="end" readonly="readonly">
						</div>
					</div>
				</div>
				<br style="clear:both" />
				<div class="col-sm-12 ">
					<div class="form-group">
						...
						<div class="col-sm-11">
							<textarea class="form-control" name="remark" id="remark" rows="6" cols="" readonly="readonly" maxlength=255></textarea>
						</div>
					</div>
				</div>
