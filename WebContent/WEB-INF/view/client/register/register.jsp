			...
			<div class="col-sm-12">
				<div class="container-fluid ">
					<div class="col-sm-12">
						<div class="row">
							<div class="col-sm-2 ">
								<button id="reset-btn" type="button" class="btn btn-block btn-success">初诊挂号</button>
							</div>
							<div class="col-sm-2">
								<button id="open-patient-dialog" type="button" class="btn btn-block btn-success">复诊挂号</button>
							</div>
						</div>
					</div>
				</div>
				...
				<form id="register-form" class="form-horizontal" role="form" action="/enjoyhisfy/client/register/save" method="post">
					...
					<input id="patId" name="patId" type="hidden" value="${register.patId }">
					<input id="isAppoint" name="isAppoint" type="hidden" value="${register.isAppoint }">
					<input id="status" name="status" type="hidden" value="${register.status }">
					...
					<div class="col-sm-12">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="patName" name="patName" value="${register.patient.patName }" placeholder="请输入名字" required="required" maxlength=50>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="hidden" class="form-control" id="age" name="age" value="${register.patient.age }" onkeyup="this.value=this.value.replace(/\D/g,'')" required="required" placeholder="请输入年龄" maxlength="11">
									<input type="text" class="form-control" id="birthday" name="strBirthday" value="${register.patient.fmtBirthday }" required="required" placeholder="">
								</div>
					...
					<div class="col-sm-12">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="mobile" name="mobile" value="${register.patient.mobile }" placeholder="请输入手机号码" maxlength=11>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<div id="source-div1" style="display: block">
										<select class="form-control" id="source" name="source" required="required" data-id="${register.source }" url="/enjoyhisfy/client/framework/FrameworkCommonAction/query4DropDown.json?table=his_dict&&column1=dict_name&&column2=dict_name&&sqlstr={'where':'dict_type=\'HZLY\''}">
										</select>
									</div>
					...
					<div class="col-sm-12">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="tel" name="tel" type="text" class="form-control" value="${register.patient.tel }" placeholder="请输入联系电话 " maxlength=45>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="address" name="address" type="text" class="form-control" value="${register.patient.address }" placeholder="地址" maxlength=255>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
					...
					<div class="col-sm-12">
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="persid" name="persid" type="text" class="form-control" value="${register.patient.persid }" placeholder="请输入身份证号" maxlength=45>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="email" name="email" type="text" class="form-control" value="${register.patient.email }" placeholder="请输入电子邮箱" maxlength=45>
								</div>
							</div>
						</div>
						<div class="col-sm-4">
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="hidden" class="form-control" readonly="readonly" id="maindocId" name="maindocId" value="${register.patient.maindocId}">
									<input type="text" class="form-control" readonly="readonly" id="maindocName" name="maindocName" value="${register.patient.maindocName}">
								</div>
							</div>
						</div>
						<div class="col-sm-4">
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" id="allergicHis" name="allergicHis" value="${register.patient.allergicHis }" maxlength=255>
								</div>
							</div>
						</div>
					</div>
