...
<body>
					...
					<div class="col-sm-12">
						...
						<div class="col-sm-4">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select class="form-control" id="dentistId" name="dentistId" required="required" data-id="${register.patient.maindocId }" url="/enjoyhisfy/client/framework/FrameworkCommonAction/query4DropDown.json?table=his_employee&&column1=id&&column2=employee_name&&sqlstr={'where':'user_type=1 and is_show=1'}">
									</select>
								</div>
							</div>
						</div>
	...
	<script src="${path}/js/client/register2.js"></script>
