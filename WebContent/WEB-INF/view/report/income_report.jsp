...
background-color: #9ACCFB;
	...
	<body>
	    ...
	    function toExl(){
	    	...
	    	window.location = "/enjoyhisfy/report/income/incomeReportToExcell.htm?strDate="+strDate+"&endDate="+endDate+"&docId="+docId
	    }
		...
		function getList(){
			...
			$.ajax({
			   url: '/enjoyhisfy/report/income/incomeReport.json?',
				type:'POST',
				async:false,
				dataType:'json',
				data:{
				...
				success:function(data,textStatus,XMLHttpRequest){
					...
					var htmlText = "";
					$(datas).each(function(){
						htmlText += '<tr><td>'+this.times+'</td><td>'+this.NAME+'</td>';
						if(this.czxje!=undefined && this.czxje!=null){
							htmlText += '<td>'+this.czxje.toFixed(2)+'</td>';
						}else{
							htmlText += '<td>0.00</td>';
						}
						if(this.yhje!=undefined && this.yhje!=null){
							htmlText += '<td>'+this.yhje.toFixed(2)+'</td>';
						}else{
							htmlText += '<td>0.00</td>';
						}
						if(this.shje!=undefined && this.shje!=null){
							htmlText += '<td>'+this.shje.toFixed(2)+'</td>';
						}else{
							htmlText += '<td>0.00</td>';
						}
						if(this.qkje!=undefined && this.qkje!=null){
							htmlText += '<td>'+this.qkje.toFixed(2)+'</td></tr>';
						}else{
							htmlText += '<td>0.00</td></tr>';
						}
					});
