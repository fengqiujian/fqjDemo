...
public class DateUtils extends PropertyEditorSupport {
	...
	// 各种时间格式
	public static final SimpleDateFormat date_month = new SimpleDateFormat("yyyy年MM月");
	// 各种时间格式
	...
	/**
	 * @Title:获取某月的最后一天 @Description: @param:@param yyyy-MM @param:@return @return:String @throws
	 */
	...
	public static Date getNow() {
		Date date = new Date();
		return str2Date(date2Str(date, date_sdf), date_sdf);
	}
	 ...
	 * @return
	 */
	public static List<WeekDay> getWeekDay(Date nowDate) {
