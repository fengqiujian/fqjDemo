...
public class YPUtil {
	...
	public static String CNChar2PY(String SourceStr) {
		YPUtil ypu = new YPUtil();
		String Result = "";
		int StrLength = SourceStr.length();
		int i;
		try {
			for (i = 0; i < StrLength; i++) {
				Result += ypu.Char2Alpha(SourceStr.charAt(i));
			}
		} catch (Exception e) {
			Result = "";
		}
	...
	public static void main(String[] args) {
		System.out.println(CNChar2PY("妃子非飞"));
		// System.out.println("妃子非".charAt(0));
	}
}
