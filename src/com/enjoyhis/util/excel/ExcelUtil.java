...
public class ExcelUtil {
	...
	public static void main(String[] args) throws IOException {
		...
		List<Object> headList = new ArrayList<>();// 表头数据
		headList.add("下单时间");
		headList.add("结账时间");
		headList.add("订单编号");
		headList.add("订单金额");
		...
		List<Object> dataList = new ArrayList<>();// 表格内的数据
		for (int i = 0; i < 15; i++) {
